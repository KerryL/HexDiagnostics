...
@ECHO #include "hexDiagnosticsApp.h">> %outputPath%%outputFile%
@ECHO.>> %outputPath%%outputFile%
@ECHO const wxString HexDiagnosticsApp::versionString = _T("%gitTag%");>> %outputPath%%outputFile%
@ECHO const wxString HexDiagnosticsApp::gitHash = _T("%gitHash%");>> %outputPath%%outputFile%
